...
`;class h extends c(a){static get config(){return{selectors:{tabs:{selector:s=>Array.from(s.children).filter(e=>e.matches('h1, h2, h3, h4, h5, h6, [slot="tab"]')),focusTarget:!0},panels:{selector:s=>Array.from(s.children).filter(e=>e.matches('h1 ~ *, h2 ~ *, h3 ~ *, h4 ~ *, h5 ~ *, h6 ~ *, [slot="panel"]')&&!e.matches('h1, h2, h3, h4, h5, h6, [slot="tab"]'))}},multiDirectional:!0,orientation:"horizontal",shouldFocus:!0,activateOnKeydown:!0,disabled:!1}}static get observedAttributes(){return[...super.observedAttributes,"vertical"]}attributeChangedCallback(s,e,i){super.attributeChangedCallback(s,e,i),s==="vertical"&&this.requestUpdate(!1)}connectedCallback(){super.connectedCallback(),this.shadowRoot.querySelector('[role="tablist"]').setAttribute("aria-label",this.getAttribute("label")||"tablist")}constructor(){super(),this.attachShadow({mode:"open"}),this.shadowRoot.appendChild(n.content.cloneNode(!0))}update(){const{tabs:s,panels:e}=this.getElements();s.forEach((i,t)=>{s[t].slot="tab",t===this.selected?(s[t].setAttribute("selected",""),s[t].setAttribute("aria-selected","true"),s[t].setAttribute("tabindex","0"),e[t].removeAttribute("hidden"),this.value=s[t].textContent.trim()):(s[t].removeAttribute("selected"),s[t].setAttribute("aria-selected","false"),s[t].setAttribute("tabindex","-1"),e[t].setAttribute("hidden","")),s[t].id.startsWith("generic-tab-")||(s[t].setAttribute("role","tab"),e[t].setAttribute("role","tabpanel"),s[t].id=`generic-tab-${this.__uuid}-${t}`,s[t].setAttribute("aria-controls",`generic-tab-${this.__uuid}-${t}`),e[t].setAttribute("aria-labelledby",`generic-tab-${this.__uuid}-${t}`))}),e.forEach((i,t)=>{e[t].slot="panel"})}}const d="generic-tabs";console.log(1,"before upgrade");customElements.define(d,h);export{d as tagName};
